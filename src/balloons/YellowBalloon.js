...
class YellowBalloon extends Component {
  ...
  render() {
    ...
    return (
        ...
        {this.state.popped
          ...
          : <div className="balloon yellowBalloon" onClick={this.popBalloon} style={{left: this.state.leftStyle, top: this.state.topStyle}}>
